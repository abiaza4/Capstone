-- Database: capstone_tutorials
CREATE DATABASE IF NOT EXISTS capstone_tutorials;
USE capstone_tutorials;
...
-- Add access tracking columns to courses
ALTER TABLE courses ADD COLUMN IF NOT EXISTS access_limit INT DEFAULT 100;
ALTER TABLE courses ADD COLUMN IF NOT EXISTS current_access INT DEFAULT 0;
...
-- Insert sample videos (at least 5 per course with 1M+ views)
-- Python videos
